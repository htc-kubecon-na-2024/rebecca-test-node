# Score - Rebecca-test-node

[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/htc-kubecon-na-2024/rebecca-test-node)
...
humctl config set app rebecca-test-node
